...
### Step 2
#### Create a New Folder within the forked repository, with the 'folder name' being your 'username' or 'Name'
...
To Run in Terminal - 
``
python mask_detect_image.py --image Dataset/with-mask/10-with-mask.jpg
``
